...
def toboggan(treelines, right, down):
    column = 0
    treecount = 0
    for line in treelines[::down]:
        if line[column] == "#":
            treecount += 1
        column = (column + right) % (len(line)-1)
    return treecount
...
#...##....##...##....##...##....##...##....##...##....##...##..O.##...##....##...##....##...##....##...##....##...##....##...##....#
.#..#...#.#.#..#...#.#.#..#...#.#.#..#...#.#.#..#...#.#.#..#...#.#.#..#...#.#.#..#...#.#.#..#...#.#.#..#...#.#.#..#...#.#.#..#...#.#"""
    testvals = list(testdata.splitlines())

    # actual vals
    vals = list(open(sys.argv[1], "r").readlines())
    if len(sys.argv) == 2:

        print(toboggan(vals, 3, 1))
        print(toboggan(testvals, 3, 1))
    else:
        # part 2
        slopes = [
            (1, 1),
        ...
        results = list(map(lambda x: toboggan(testvals, x[0], x[1]), slopes))
        print(np.prod(results))
        results = list(map(lambda x: toboggan(vals, x[0], x[1]), slopes))
        print(np.prod(results))
