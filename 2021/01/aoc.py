...
def main():
    ...
    increase_count = increase_counter(input)

    print(f"part one: {increase_count}")
    ...
    increase_count = increase_counter(sums)

    print(f"part two: {increase_count}")
